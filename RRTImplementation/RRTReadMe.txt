...
NOTES:
This program will randomly place one 20-by-20 size object in the middle of the graph that will be avoided.The default starting and destination locations will always be outside of the created object, however, that can not be gaurenteed if changed.
